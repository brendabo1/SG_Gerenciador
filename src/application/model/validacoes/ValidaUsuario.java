...
/**
 * Classe respons�vel por identificar os objetos e valores correspondentes ao usuario aceito pelo sistema.
...
public class ValidaUsuario {
	...
	/**
	 * Verifica se o usuario � valido a partir da validacao de nome e senha
	 * @param nome String correspondente ao nome
	 * @param senha String correspondente a senha
